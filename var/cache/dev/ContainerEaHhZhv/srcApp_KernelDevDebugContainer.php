...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getRecipesControllerService()
    {
        ...
        $this->services['App\\Controller\\RecipesController'] = $instance = new \App\Controller\RecipesController(new \App\Service\RecipeService(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['App\\Repository\\RecipeRepository'] ?? $this->getRecipeRepositoryService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService())));
